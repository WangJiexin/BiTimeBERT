...
def setup_task(args):
    result = TASK_REGISTRY[args.task].setup_task(args)
    #TASK_REGISTRY = {'temp_bert': fairseq.tasks.temp_bert.TempBertTask}
    #args.task = "temp_bert" (always should be set to "temp_bert")
    #result->TempBertTask object, also load dictionary in this step
    return result
