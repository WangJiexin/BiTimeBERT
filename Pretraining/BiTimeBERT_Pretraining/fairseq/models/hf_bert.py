...
from . import FairseqIncrementalDecoder, FairseqLanguageModel, register_model, register_model_architecture
...
from pytorch_pretrained_bert import BertModel as BM
from pytorch_pretrained_bert import BertTokenizer as BertTokenizer1
from pytorch_pretrained_bert import BertModel as BertModel1
from pytorch_pretrained_bert import BertForMaskedLM as BertForMaskedLM1
from transformers import BertTokenizer as BertTokenizer2
from transformers import BertConfig as BertConfig2
from transformers import BertForPreTraining as BertForPreTraining2
...
class BertHF(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.use_pretrained_model:
            decoder = BertForPreTraining.from_pretrained(args.use_pretrained_model)
            #decoder = BM.from_pretrained(args.use_pretrained_model)
        else:
        ...
        {"attention_probs_dropout_prob": 0.1, "hidden_act": "gelu",
          ...
          "num_hidden_layers": 12, "type_vocab_size": 2,
          "vocab_size": 28996}
        """

        # Load pre-trained model tokenizer (vocabulary)
        tokenizer = BertTokenizer1.from_pretrained(args.use_pretrained_model)
        # Tokenized input
        ...
        model1 = BertModel1.from_pretrained('bert-base-cased')
        
        decoder.eval()
        model1.eval()

        encoded_layers, pooled_output = decoder(tokens_tensor, segments_tensors)
        print(encoded_layers[0]) #[ 0.6366, -0.3668,  0.2740,  ..., -0.8997, -0.0746, -0.0360]
        
        encoded_layers, pooled_output = model1(tokens_tensor, segments_tensors)
        print(encoded_layers[0]) #[ 0.6366, -0.3668,  0.2740,  ..., -0.8997, -0.0746, -0.0360]

        bertconfig2 = BertConfig2.from_pretrained('bert-base-cased')
        model2 = BertForPreTraining2.from_pretrained('bert-base-cased', config=bertconfig2)
        model2.eval()
        results = model2(tokens_tensor, segments_tensors)
        print(results) #[ 0.6366, -0.3668,  0.2740,  ..., -0.8997, -0.0746, -0.0360]
