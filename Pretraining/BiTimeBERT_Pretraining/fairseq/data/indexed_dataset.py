...
class IndexedDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, path, fix_lua_indexing=True, read_data=True):
        super().__init__()
        self.fix_lua_indexing = fix_lua_indexing  #fix_lua_indexing=False
...
class IndexedInMemoryDataset(IndexedDataset):
    ...
    def read_data(self, path):
        ...
        self.data_file.close()
        if self.fix_lua_indexing: #self.fix_lua_indexing=False
            self.buffer-=1
